odoo.define('pos_member_type.PartnerDetailsEdit', function(require) {
    ...
    class PartnerDetailsEdit extends PosComponent {
        ...
        console.log('setup');
            super.setup();
            this.intFields = ['country_id', 'state_id', 'property_product_pricelist','pos_member_type_id'];
            const partner = this.props.partner;
            console.log('partner',partner);
            this.changes = {
                'country_id': partner.country_id && partner.country_id[0],
                'state_id': partner.state_id && partner.state_id[0],
                'pos_member_type_id': partner.pos_member_type_id && partner.pos_member_type_id[0]
            };
